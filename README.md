...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `551.1µs` | `584.4µs` |
| [Day 2](./src/bin/02.rs) | `144.4µs` | `150.8µs` |
| [Day 3](./src/bin/03.rs) | `508.2µs` | `249.3µs` |
| [Day 4](./src/bin/04.rs) | `296.5µs` | `339.7µs` |
| [Day 5](./src/bin/05.rs) | `31.5µs` | `65.7µs` |
| [Day 6](./src/bin/06.rs) | `332.0ns` | `657.0ns` |
| [Day 7](./src/bin/07.rs) | `4.7ms` | `6.4ms` |
| [Day 8](./src/bin/08.rs) | `397.6µs` | `13.5ms` |
| [Day 9](./src/bin/09.rs) | `293.4µs` | `295.5µs` |
| [Day 10](./src/bin/10.rs) | `287.2µs` | `6.2ms` |
| [Day 11](./src/bin/11.rs) | `216.2µs` | `208.6µs` |
| [Day 12](./src/bin/12.rs) | `772.8µs` | `17.9ms` |
| [Day 15](./src/bin/15.rs) | `92.2µs` | `539.7µs` |
| [Day 16](./src/bin/16.rs) | `1.0ms` | `22.2ms` |

...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `290.5µs` | `533.0µs` |
| [Day 2](./src/bin/02.rs) | `228.4µs` | `276.3µs` |
| [Day 3](./src/bin/03.rs) | `1.5ms` | `652.1µs` |
| [Day 4](./src/bin/04.rs) | `482.9µs` | `528.0µs` |
| [Day 5](./src/bin/05.rs) | `58.9µs` | `206.8µs` |
| [Day 6](./src/bin/06.rs) | `622.0ns` | `954.0ns` |
| [Day 7](./src/bin/07.rs) | `9.0ms` | `10.9ms` |
| [Day 8](./src/bin/08.rs) | `565.9µs` | `20.4ms` |
| [Day 9](./src/bin/09.rs) | `2.2ms` | `2.2ms` |
| [Day 10](./src/bin/10.rs) | `445.2µs` | `10.9ms` |
| [Day 11](./src/bin/11.rs) | `386.5µs` | `377.3µs` |
| [Day 12](./src/bin/12.rs) | `1.3ms` | `74.0ms` |
| [Day 15](./src/bin/15.rs) | `126.4µs` | `984.8µs` |

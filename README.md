...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `168.7µs` | `2.1ms` |
| [Day 2](./src/bin/02.rs) | `254.7µs` | `278.0µs` |
| [Day 3](./src/bin/03.rs) | `-` | `-` |
| [Day 4](./src/bin/04.rs) | `511.6µs` | `576.6µs` |
| [Day 5](./src/bin/05.rs) | `40.5µs` | `91.3µs` |
| [Day 6](./src/bin/06.rs) | `673.0ns` | `1.1µs` |
